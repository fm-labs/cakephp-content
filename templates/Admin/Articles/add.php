<?php $this->Breadcrumbs->add(__d('content','Articles'), ['action' => 'index']); ?>
<?php $this->Breadcrumbs->add(__d('content','New {0}', __d('content','Article'))); ?>
<?php
//$this->extend('/Admin/Content/add');
// EXTEND: HEADING
$this->assign('heading', __d('content','Add {0}', __d('content','Article')));
?>
<div class="posts">
