 ...
 * Article Entity.
 */
class Article extends Entity /*implements EntityTypeHandlerInterface*/
{
    ...
    {
        $config = ArticleManager::getType($type);
        if ($config && isset($config['className'])) {
            $class = App::className($config['className'], 'Model/Entity/Article', 'ArticleType');
