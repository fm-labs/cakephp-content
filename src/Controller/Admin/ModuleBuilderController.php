                ...
                /*
                    if ($refscope && $refid) {
                        ...
                        if ($contentModule = $this->ContentModules->save($contentModule)) {
                            $this->Flash->success(__d('content','Module has been saved with ID {0} and linked to content {1} #{2} with ID {3}',
                                $module->id,
                                $refscope,
                                $refid,
                                $contentModule->id
                            ...
                            $this->Flash->error(__d('content','Module has been saved with ID {0} but not linked to content {1}',
                                $module->id,
                                $class
                            ));
                        }
